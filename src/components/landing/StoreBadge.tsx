...
const StoreBadge = ({ store, href, highlighted, className }: StoreBadgeProps) => {
  ...
  return (
    <motion.a
      ...
      className={cn(
        "group relative inline-flex w-full max-w-[320px] items-center justify-center gap-3 rounded-2xl border px-5 py-3 backdrop-blur-2xl transition-colors sm:max-w-none sm:w-auto sm:justify-start",
        highlighted
