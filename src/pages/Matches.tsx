          ...
          >
            ...
            <div className="h-full w-full overflow-y-auto overflow-x-hidden no-scrollbar pb-36">
              ...
              <div className="relative w-full aspect-square max-h-[50vh] bg-card overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 <div className="absolute bottom-0 left-0 right-0 h-48 bg-gradient-to-t from-background via-background/80 to-transparent" />" />
              </div>
